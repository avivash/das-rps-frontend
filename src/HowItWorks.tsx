...
const steps: StepProps[] = [
  {
    ...
    content:
      "Choose your signup method using your own wallet or using an embedded wallet with Privy.",
    finePrint:
      "This is the wallet that will be used to sign the offchain attestations.",
    hasFooter: false,
  },
  {
    Icon: FaRegHandRock,
    ...
    content:
      "When a user starts a challenge, they are attesting to the recipient address they want to challenge." +
      "\n" +
    ...
    footerLink:
      "https://sepolia.easscan.org/offchain/attestation/view/0xd99d109a236f1821fec6fe9784b8d000a6395bf10357f96e78838a04df72afa3",
    footerLinkText: formatAttestationLongValueV2(
      "0xd99d109a236f1821fec6fe9784b8d000a6395bf10357f96e78838a04df72afa3"
    ),
  },
  {
    Icon: FaRegHandPaper,
    ...
    content:
      `Now that a game has been created, each player will see the “Active” or "Incoming" Game in the UI.\n` +
      "\n" +
    ...
    footerLinkText: formatAttestationLongValueV2(
      "0xdc83e58dd6940b816424f91ce974700870884d1a65b04633f18fee75f773678e"
    ),
    footerLink:
      "https://sepolia.easscan.org/offchain/attestation/view/0xdc83e58dd6940b816424f91ce974700870884d1a65b04633f18fee75f773678e",
  },
  {
    Icon: FaFlagCheckered,
    title: "Revealing a Move",
    content:
      "Once both players have committed to their moves, they can reveal their moves. This is done by submitting the original move and salt to the server, thus making the information public. " +
      "\n" +
    ...
    finePrint:
      "Although the server can time out a player, and the game's result will be displayed as such on RPS.sh, " +
  ...
  },
  {
    ...
    content:
      "We attest to the game result and provide all relevant attestations in their game summary." +
      "\n" +
    ...
    footerLink:
      "https://sepolia.easscan.org/offchain/attestation/view/0xdf752a2113f54c4c1e6386eba61305b0eb5bbb0b5089a449176c4c6a72196440",
    footerLinkText: formatAttestationLongValueV2(
      "0xdf752a2113f54c4c1e6386eba61305b0eb5bbb0b5089a449176c4c6a72196440"
    ),
  },
  {
    Icon: BiTrophy,
    ...
    content:
      "Our server adjusts the users ELO rating based on who they played and the result. This influences their spot on the leaderboard.",
    hasFooter: false,
  },
  {
    Icon: HiOutlineUsers,
    ...
    content:
      "As the user plays more people, we begin to create a relative social graph of who they’ve played and who those people have played.",
    hasFooter: true,
...
export default function HowItWorks() {
  return (
    <FullPageContainer>
      ...
      <TitleDescription>
        RPS uses a series of offchain attestations to play the game. Here’s how
